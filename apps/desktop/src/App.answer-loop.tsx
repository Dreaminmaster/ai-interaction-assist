    ...
    <div className="app-shell">
      ...
      <aside className="right-panel">
        ...
        <div className="chat-card assistant">
          ...
          <div className="chat-text">当前页面已经形成第一版最小闭环：开始本轮学习、填写回答、更新本轮沉淀。</div>
        </div>
        <div className="chat-card assistant">
          <div className="chat-role">下一步</div>
          <div className="chat-text">后续可以继续把主题档案同步更新，并把回答分析替换成真正的 AI 诊断。</div>
        </div>
      </aside>
    </div>
  );
